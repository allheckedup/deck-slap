...
export const UnknownApplication = ({ path }: UnknownApplicationProps) => (
  <FramedApplication config={UNKNOWN_APP} className={styles.applicationRoot}>
    ...
    <div className={styles.content}>
      This is probably because we haven&apos;t coded it in yet... unless we have and then please
      complain <a href="https://github.com/allheckedup/deck-slap/issues">here</a>.
    </div>
  </FramedApplication>
)
